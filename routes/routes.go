...
import (
	controller "github.com/ThembinkosiThemba/restuarent/controllers"
...
func FoodRoutes(incomingRoutes *gin.Engine) {
	...
	incomingRoutes.PUT("/foods/:id", controller.UpdateFood())
	// incomingRoutes.DELETE("/foods/:id", DeleteFood)
}
